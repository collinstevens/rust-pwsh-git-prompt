...
$childArguments = @('--no-pager', 'branch')
...
[pscustomobject]@{
    Benchmark = 'git-branch'
    Metric = 'Parent timestamp immediately before Process.Start until WaitForExit returns; includes Git startup, branch listing, redirected output, and shutdown.'
